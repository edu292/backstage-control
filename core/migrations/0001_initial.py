    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor_total', models.GeneratedField(db_persist=False, expression=django.db.models.expressions.CombinedExpression(models.F('quantidade'), '*', models.F('preco_unidade')), output_field=models.DecimalField(decimal_places=4, max_digits=10))),
