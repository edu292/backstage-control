    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preco_medio', models.GeneratedField(db_persist=True, expression=models.Case(models.When(quantidade_em_estoque=0, then=models.Value('0.00')), default=django.db.models.expressions.CombinedExpression(models.F('valor_total'), '/', models.F('quantidade_em_estoque')), output_field=models.DecimalField(decimal_places=4, max_digits=10)), output_field=models.DecimalField(decimal_places=4, max_digits=10))),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantidade_faltando', models.GeneratedField(db_persist=True, expression=django.db.models.expressions.CombinedExpression(models.F('quantidade_solicitada'), '-', models.F('quantidade_alocada')), output_field=models.PositiveIntegerField())),
                ('evento', models.ForeignKey(limit_choices_to={'status': 'andamento'}, on_delete=django.db.models.deletion.CASCADE, related_name='solicitacoes', to='core.evento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.CharField(choices=[('compra', 'Compra'), ('alocacao', 'Alocação para Evento'), ('retorno', 'Retorno de Evento'), ('remocao', 'Remoção Manual'), ('adicao', 'Adição Manual'), ('patrocinio', 'Patrocínio'), ('consumo', 'Consumo Interno')], db_index=True, max_length=20)),
                ...
                ('valor_total', models.GeneratedField(db_persist=True, expression=django.db.models.expressions.CombinedExpression(models.F('quantidade'), '*', models.F('preco_unidade')), output_field=models.DecimalField(decimal_places=4, max_digits=10))),
                ('evento', models.ForeignKey(blank=True, limit_choices_to={'status': 'andamento'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transacoes', to='core.evento')),
